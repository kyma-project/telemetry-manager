...
// +kubebuilder:webhook:path=/validate-tracepipeline,mutating=false,failurePolicy=fail,sideEffects=None,groups=telemetry.kyma-project.io,resources=tracepipelines,verbs=create;update,versions=v1beta1,name=validating-tracepipelines.kyma-project.io,admissionReviewVersions=v1;v1beta1
