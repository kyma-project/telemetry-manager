...
func (_m *DryRunner) RunParser(ctx context.Context, parser *telemetryv1alpha1.LogParser) error {
	ret := _m.Called(ctx, parser)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *telemetryv1alpha1.LogParser) error); ok {
		r0 = rf(ctx, parser)
	} else {
		r0 = ret.Error(0)
	}
