...
func (_m *DryRunner) RunPipeline(ctx context.Context, pipeline *telemetryv1alpha1.LogPipeline) error {
	ret := _m.Called(ctx, pipeline)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *telemetryv1alpha1.LogPipeline) error); ok {
		r0 = rf(ctx, pipeline)
	} else {
		r0 = ret.Error(0)
	}
