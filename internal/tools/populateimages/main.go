...
var templates = map[string]string{
	"./internal/images/images.go": `// This file is generated by "make generate".
// Don't edit, update .env file and run make target generate.

package images

const (
	DefaultFluentBitExporterImage = "{{ .DEFAULT_FLUENTBIT_EXPORTER_IMAGE }}"
	DefaultFluentBitImage         = "{{ .DEFAULT_FLUENTBIT_IMAGE }}"
	DefaultOTelCollectorImage     = "{{ .DEFAULT_OTEL_COLLECTOR_IMAGE }}"
	DefaultSelfMonitorImage       = "{{ .DEFAULT_SELFMONITOR_IMAGE }}"
)
`,
