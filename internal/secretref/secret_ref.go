...
func GetLogPipelineRefs(lp *telemetryv1beta1.LogPipeline) []telemetryv1beta1.SecretKeyRef {
	...
	refs = append(refs, getHTTPOutputRefs(lp.Spec.Output.FluentBitHTTP)...)

	return refs
}

func getHTTPOutputRefs(httpOutput *telemetryv1beta1.FluentBitHTTPOutput) []telemetryv1beta1.SecretKeyRef {
	var refs []telemetryv1beta1.SecretKeyRef
...
func GetOTLPOutputRefs(otlpOut *telemetryv1beta1.OTLPOutput) []telemetryv1beta1.SecretKeyRef {
	var refs []telemetryv1beta1.SecretKeyRef
