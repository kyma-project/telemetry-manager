// Copied over from "github.com/open-telemetry/opentelemetry-collector-contrib/processor/transformprocessor/internal/common/processors.go"
...
type resourceStatements struct {
	...
	BoolExpr[ottlresource.TransformContext]
}
...
type scopeStatements struct {
	...
	BoolExpr[ottlscope.TransformContext]
}
...
type baseContext interface {
	// TODO: uncomment when TracesConsumer and MetricsConsumer are added
	// TracesConsumer
	// MetricsConsumer
	LogsConsumer
}
...
func parseResourceContextStatements[R any](
	...
	globalExpr, errGlobalBoolExpr := parseGlobalExpr(NewBoolExprForResourceWithOptions, contextStatements.Conditions, errorMode, pc.Settings, ottlfuncs.StandardConverters[ottlresource.TransformContext](), parserOptions)
...
func parseScopeContextStatements[R any](
	...
	globalExpr, errGlobalBoolExpr := parseGlobalExpr(NewBoolExprForScopeWithOptions, contextStatements.Conditions, errorMode, pc.Settings, ottlfuncs.StandardConverters[ottlscope.TransformContext](), parserOptions)
	if errGlobalBoolExpr != nil {
		return *new(R), errGlobalBoolExpr
	}
