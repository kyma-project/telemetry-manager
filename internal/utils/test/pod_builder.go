		...
		ContainerStatuses: []corev1.ContainerStatus{
			{
				...
				State: corev1.ContainerState{
					Waiting: &corev1.ContainerStateWaiting{
						...
						Message: "back-off 1m20s restarting failed container=collector pod=telemetry-otlp-gateway-757759865f-wnx7h_kyma-system(9525d87f-7e91-402c-995d-6f64fda1c2c6)",
					},
				},
