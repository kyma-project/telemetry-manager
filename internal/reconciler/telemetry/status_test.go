...
func TestUpdateStatus(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			metricsCheckerReturn: &metav1.Condition{Type: "MetricComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
			...
			expectedConditions: []metav1.Condition{
				...
				{Type: "MetricComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
		...
		},
		{
			...
			logsCheckerReturn:    &metav1.Condition{Type: "LogComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
			metricsCheckerReturn: &metav1.Condition{Type: "MetricComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
			tracesCheckerReturn:  &metav1.Condition{Type: "TraceComponentsHealthy", Status: metav1.ConditionFalse, Reason: conditions.ReasonComponentsRunning},
			resources: []client.Object{
			...
			expectedConditions: []metav1.Condition{
				{Type: "LogComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
				{Type: "MetricComponentsHealthy", Status: metav1.ConditionTrue, Reason: conditions.ReasonComponentsRunning},
				{Type: "TraceComponentsHealthy", Status: metav1.ConditionFalse, Reason: conditions.ReasonComponentsRunning},
			},
			expectedEndpoints: operatorv1alpha1.GatewayEndpoints{Metrics: &operatorv1alpha1.OTLPEndpoints{
				GRPC: "http://metrics.telemetry-system:4317",
				HTTP: "http://metrics.telemetry-system:4318",
