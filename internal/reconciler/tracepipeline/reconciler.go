...
func getDeployableTracePipelines(ctx context.Context, allPipelines []telemetryv1alpha1.TracePipeline, client client.Client, lock *utils.ResourceCountLock) ([]telemetryv1alpha1.TracePipeline, error) {
