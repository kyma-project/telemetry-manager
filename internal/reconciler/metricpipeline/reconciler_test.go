...
func TestReconcile(t *testing.T) {
	...
	t.Run("some metric pipelines do not require an agent", func(t *testing.T) {
		...
		agentConfigBuilderMock := &mocks.AgentConfigBuilder{}
		agentConfigBuilderMock.On("Build", mock.Anything, containsPipelines([]telemetryv1alpha1.MetricPipeline{pipeline1, pipeline2}), mock.Anything).Return(&common.Config{}, nil, nil)
