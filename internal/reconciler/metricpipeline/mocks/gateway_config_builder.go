...
func (_mock *GatewayConfigBuilder) Build(ctx context.Context, pipelines []v1alpha1.MetricPipeline, options gateway.BuildOptions) (*gateway.Config, otlpexporter.EnvVars, error) {
	...
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []v1alpha1.MetricPipeline, gateway.BuildOptions) (*gateway.Config, otlpexporter.EnvVars, error)); ok {
		return returnFunc(ctx, pipelines, options)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []v1alpha1.MetricPipeline, gateway.BuildOptions) *gateway.Config); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, []v1alpha1.MetricPipeline, gateway.BuildOptions) otlpexporter.EnvVars); ok {
	...
	if returnFunc, ok := ret.Get(2).(func(context.Context, []v1alpha1.MetricPipeline, gateway.BuildOptions) error); ok {
...
func (_c *GatewayConfigBuilder_Build_Call) Run(run func(ctx context.Context, pipelines []v1alpha1.MetricPipeline, options gateway.BuildOptions)) *GatewayConfigBuilder_Build_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 gateway.BuildOptions
		if args[2] != nil {
			arg2 = args[2].(gateway.BuildOptions)
		}
		run(
			arg0,
			arg1,
...
func (_c *GatewayConfigBuilder_Build_Call) RunAndReturn(run func(ctx context.Context, pipelines []v1alpha1.MetricPipeline, options gateway.BuildOptions) (*gateway.Config, otlpexporter.EnvVars, error)) *GatewayConfigBuilder_Build_Call {
	_c.Call.Return(run)
	return _c
}
