...
func (_mock *GatewayConfigBuilder) Build(ctx context.Context, pipelines []v1alpha1.LogPipeline, opts loggateway.BuildOptions) (*common.Config, common.EnvVars, error) {
	...
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []v1alpha1.LogPipeline, loggateway.BuildOptions) (*common.Config, common.EnvVars, error)); ok {
		return returnFunc(ctx, pipelines, opts)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []v1alpha1.LogPipeline, loggateway.BuildOptions) *common.Config); ok {
...
func (_c *GatewayConfigBuilder_Build_Call) RunAndReturn(run func(ctx context.Context, pipelines []v1alpha1.LogPipeline, opts loggateway.BuildOptions) (*common.Config, common.EnvVars, error)) *GatewayConfigBuilder_Build_Call {
	_c.Call.Return(run)
	return _c
}
