...
var otelLogPipelineMessages = map[string]string{
	...
	ReasonSelfMonGatewayAllDataDropped:  "Backend is not reachable or rejecting logs. All logs are dropped in Log gateway.",
	ReasonSelfMonAgentAllDataDropped:    "Backend is not reachable or rejecting logs. All logs are dropped in Log agent.",
	ReasonSelfMonGatewayBufferFillingUp: "Buffer in Log gateway nearing capacity. Incoming log rate exceeds export rate.",
	ReasonSelfMonAgentBufferFillingUp:   "Buffer in Log agent nearing capacity. Incoming log rate exceeds export rate.",
	ReasonSelfMonGatewaySomeDataDropped: "Backend is reachable, but rejecting logs. Some logs are dropped in Log gateway.",
	ReasonSelfMonAgentSomeDataDropped:   "Backend is reachable, but rejecting logs. Some logs are dropped in Log agent.",
