...
func pipelinesConfig(inputs inputSources) common.Pipelines {
	pipelinesCfg := make(common.Pipelines)

	if inputs.runtime {
		pipelinesCfg["metrics/runtime"] = common.Pipeline{
	...
	if inputs.prometheus {
		pipelinesCfg["metrics/prometheus"] = common.Pipeline{
	...
	if inputs.istio {
		pipelinesCfg["metrics/istio"] = common.Pipeline{
