...
func TestProcessors(t *testing.T) {
	...
	t.Run("set instrumentation scope runtime", func(t *testing.T) {
		...
		expectedSetInstrumentationScopeRuntime := common.TransformProcessor{
			ErrorMode: "ignore",
			MetricStatements: []common.TransformProcessorStatements{
				{
					Statements: []string{
	...
	t.Run("insert skip enrichment attribute processor", func(t *testing.T) {
		...
		expectedInsertSkipEnrichmentAttributeProcessor := common.TransformProcessor{
			ErrorMode: "ignore",
			MetricStatements: []common.TransformProcessorStatements{
				{
