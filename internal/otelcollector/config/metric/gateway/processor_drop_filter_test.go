...
func TestDropDiagnosticMetricsForInput(t *testing.T) {
	dropFilterIstio := dropDiagnosticMetricsFilterConfig(inputSourceEquals("istio"))
	dropFilterPrometheus := dropDiagnosticMetricsFilterConfig(inputSourceEquals("prometheus"))
