...
func TestMakeConfig(t *testing.T) {
	...
	t.Run("single pipeline topology", func(t *testing.T) {
		...
		require.Contains(t, collectorConfig.Service.Pipelines["traces/test"].Receivers, "otlp/trace-receiver")
	...
	t.Run("multi pipeline topology", func(t *testing.T) {
		...
		require.Contains(t, collectorConfig.Service.Pipelines["traces/test-1"].Receivers, "otlp/trace-receiver")
		...
		require.Contains(t, collectorConfig.Service.Pipelines["traces/test-2"].Receivers, "otlp/trace-receiver")
