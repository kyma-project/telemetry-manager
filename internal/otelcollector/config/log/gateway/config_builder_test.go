...
func TestBuildConfig(t *testing.T) {
	...
	t.Run("single pipeline topology", func(t *testing.T) {
		...
		require.Equal(t, collectorConfig.Service.Pipelines["logs/test"].Processors[3], "istio_noise_filter")
	...
	t.Run("multi pipeline topology", func(t *testing.T) {
		...
		require.Equal(t, collectorConfig.Service.Pipelines["logs/test-1"].Processors[3], "istio_noise_filter")
		...
		require.Equal(t, collectorConfig.Service.Pipelines["logs/test-2"].Processors[3], "istio_noise_filter")
	...
	t.Run("otlp input disabled multi pipeline", func(t *testing.T) {
		...
		require.Equal(t, collectorConfig.Service.Pipelines["logs/test-otlp-disabled"].Processors[3], "istio_noise_filter")
		...
		require.Equal(t, collectorConfig.Service.Pipelines["logs/test-otlp-enabled"].Processors[3], "istio_noise_filter")
