...
func checkTelemetryModuleMetricState(t *testing.T, g Gomega, body []byte) {
	...
	g.Expect(body).To(HaveFlatMetrics(
		ContainElement(SatisfyAll(
			...
			HaveMetricAttributes(HaveKeyWithValue("name", "default")),
			HaveMetricAttributes(HaveKeyWithValue("namespace", kitkyma.SystemNamespaceName)),
			HaveMetricAttributes(HaveKeyWithValue("group", "operator.kyma-project.io")),
			HaveMetricAttributes(HaveKeyWithValue("version", "v1beta1")),
			HaveMetricAttributes(HaveKeyWithValue("kind", "telemetries")),
...
func checkMetricPipelineMetricsConditions(t *testing.T, g Gomega, body []byte, typeName, pipelineName string) {
	...
	g.Expect(body).To(HaveFlatMetrics(
		ContainElement(SatisfyAll(
			...
			HaveMetricAttributes(HaveKey("status")),
			HaveMetricAttributes(HaveKey("reason")),
			HaveMetricAttributes(HaveKeyWithValue("name", pipelineName)),
			HaveMetricAttributes(HaveKeyWithValue("group", "telemetry.kyma-project.io")),
			HaveMetricAttributes(HaveKeyWithValue("version", "v1beta1")),
			HaveMetricAttributes(HaveKeyWithValue("kind", "metricpipelines")),
