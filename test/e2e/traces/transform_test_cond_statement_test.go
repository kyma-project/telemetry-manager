...
func TestTransform_StatementCond(t *testing.T) {
	...
	resources := []client.Object{
		...
		&pipeline,
		telemetrygen.NewPod(genNs, telemetrygen.SignalTypeTraces, telemetrygen.WithTelemetryAttribute("component", "proxy")).K8sObject(),
	}
