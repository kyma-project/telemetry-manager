		...
		It("Ensures all defined diagnostic metrics are sent to the backend", func() {
			Eventually(func(g Gomega) {
				...
				g.Expect(resp).To(HaveHTTPBody(
					WithFlatMetricsDataPoints(WithAllNames(ContainElements("up", "scrape_duration_seconds", "scrape_samples_scraped", "scrape_samples_post_metric_relabeling", "scrape_series_added")))))
