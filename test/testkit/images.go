...
const (
	DefaultTelemetryGenImage         = "ghcr.io/open-telemetry/opentelemetry-collector-contrib/telemetrygen:v0.158.0"
	DefaultOTelCollectorContribImage = "otel/opentelemetry-collector-contrib:latest"
	DefaultOTelCollectorImage        = "europe-docker.pkg.dev/kyma-project/prod/kyma-otel-collector:0.158.0-1.70.0"
	...
	ChownImage                       = "europe-docker.pkg.dev/kyma-project/prod/telemetry-chown:v20260821-d92ca276"
)
