...
// UnmarshalOTLPData reads and unmarshals pdata signals from a JSONL-encoded file data (every line is a JSON document encoding OTLP data).
...
func UnmarshalOTLPData[T plog.Logs | pmetric.Metrics | ptrace.Traces](jsonData []byte, unmarshalFunc func(buf []byte) (T, error)) ([]T, error) {
	var otlpData []T
