...
func TestMultiPipelineNamespaceSelector(t *testing.T) {
	...
	assert.MetricsFromNamespaceDeliveredWithT(t, backend1, app1Ns, runtime.DefaultMetricsNames)
	assert.MetricsFromNamespaceDeliveredWithT(t, backend1, app1Ns, prommetricgen.CustomMetricNames())
	assert.MetricsFromNamespaceDeliveredWithT(t, backend1, app1Ns, telemetrygen.MetricNames)
	assert.MetricsFromNamespaceNotDeliveredWithT(t, backend1, app2Ns)
	assert.MetricsFromNamespaceDeliveredWithT(t, backend2, app2Ns, runtime.DefaultMetricsNames)
	assert.MetricsFromNamespaceDeliveredWithT(t, backend2, app2Ns, prommetricgen.CustomMetricNames())
	assert.MetricsFromNamespaceDeliveredWithT(t, backend2, app2Ns, telemetrygen.MetricNames)
	assert.MetricsFromNamespaceNotDeliveredWithT(t, backend2, app1Ns)
}
