...
- [Filtering and Processing Data](/telemetry-manager/user/filter-and-process/README.md)
  ...
  - [Transform and Filter Telemetry Data with OTTL](/telemetry-manager/user/filter-and-process/ottl-transform-and-filter/README.md)
    - [Transform with OTTL](/telemetry-manager/user/filter-and-process/ottl-transform-and-filter/ottl-transform.md)
    - [Filter with OTTL](/telemetry-manager/user/filter-and-process/ottl-transform-and-filter/ottl-filter.md)
