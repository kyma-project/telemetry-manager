...
> To change how often Prometheus endpoints are scraped, configure the collection interval (see [Configure Collection Interval](README.md#configure-collection-interval)).
