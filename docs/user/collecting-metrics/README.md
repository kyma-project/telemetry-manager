...
By default, the Metric Agent and OTLP Gateway preserve the temporality of all collected metrics. To convert cumulative metrics to delta temporality, set the **output.otlp.temporality** field to delta:
