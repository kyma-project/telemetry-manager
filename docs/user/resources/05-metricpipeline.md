...
| **input.&#x200b;application.&#x200b;istio.&#x200b;enabled**  | boolean | If enabled, metric for istio-proxy containers will be scraped from pods that have had the istio-proxy sidecar injected. |
