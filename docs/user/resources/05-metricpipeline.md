...
| GatewayHealthy         | False            | GatewayNotReady             | Pod is in pending state as container: `container name` is not running due to: `reason`                                                                                                                                                   |
| GatewayHealthy         | False            | GatewayNotReady             | Pod is in failed state due to: `reason`                                                                                                                                                                                                  |
...
| AgentHealthy           | False            | AgentNotReady               | Pod is in pending state as container: `container name` is not running due to: `reason`                                                                                                                                                   |
| AgentHealthy           | False            | AgentNotReady               | Pod is in failed state due to: `reason`                                                                                                                                                                                                  |
