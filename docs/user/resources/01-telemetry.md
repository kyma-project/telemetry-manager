...
| False            | ReferencedSecretInvalid     | One or more referenced Secrets are missing: Secret 'my-secret' of Namespace 'my-namespace'                                                                                                                                                                |
| False            | ReferencedSecretInvalid     | One or more keys in a referenced Secret are missing: Key 'my-key' in Secret 'my-secret' of Namespace 'my-namespace'"                                                                                                                                      |
| False            | ReferencedSecretInvalid     | Secret reference is missing field/s: (field1, field2, ...)                                                                                                                                                                                                |
