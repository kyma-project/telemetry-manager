...
| True             | TLSCertificateAboutToExpire | TLS certificate/CA is about to expire, configured certificate/CA is valid until YYYY-MM-DD                                                                                                                                                                      |
...
| False            | TLSCertificateExpired       | TLS certificate/CA expired on YYYY-MM-DD                                                                                                                                                                                                                     |
