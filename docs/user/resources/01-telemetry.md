...
| False            | OTTLSpecInvalid                 | OTTL specification is invalid, <FilterSpec/TransformSpec>: `reason`. Fix the syntax error indicated by the message or see troubleshooting: [OTTL Spec Invalid with Unspecific Error Message](https://kyma-project.io/#/telemetry-manager/user/03-traces?id=ottl_spec_invalid_with_unspecific_error_message) |
...
| False            | OTTLSpecInvalid                 | OTTL specification is invalid, <FilterSpec/TransformSpec>: `reason`. Fix the syntax error indicated by the message or see troubleshooting: [OTTL Spec Invalid with Unspecific Error Message](https://kyma-project.io/#/telemetry-manager/user/04-metrics?id=ottl_spec_invalid_with_unspecific_error_message) |
