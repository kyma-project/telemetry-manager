...
| TelemetryFlowHealthy   | False            | GatewayThrottling               | OTLP gateway is unable to receive spans at current rate. See troubleshooting: [Gateway Throttling](https://kyma-project.io/#/telemetry-manager/user/03-traces?id=gateway-throttling)                                                                                                                                                   |
