...
| **unsupportedMode**  | boolean | Is active when the LogPipeline uses a `custom` output or filter; see [unsupported mode](https://kyma-project.io/#/telemetry-manager/docs/user/02-logs.md#unsupported-mode). |
