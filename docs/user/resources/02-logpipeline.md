...
| **unsupportedMode**  | boolean | Is active when the LogPipeline uses a `custom` output or filter; see [unsupported mode](https://kyma-project.io/docs/kyma/latest/01-overview/main-areas/telemetry/telemetry-02-logs#unsupported-mode). |
