...
| **output.&#x200b;grafana-loki**  | object | The grafana-loki output is not supported anymore. For integration with a custom Loki installation use the `custom` output, check [Installing a custom Loki stack in Kyma](https://github.com/kyma-project/examples/tree/main/loki). |
