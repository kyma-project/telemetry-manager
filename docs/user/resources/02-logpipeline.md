...
| Condition Type         | Condition Status | Condition Reason            | Condition Message                                                                                                                                                                                                                      | Description                                                     |
|------------------------|------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| AgentHealthy           | True             | AgentReady                  | Fluent Bit agent DaemonSet is ready                                                                                                                                                                                                    |                                                                 |
| AgentHealthy           | True             | AgentReady                  | Rollout is in progress                                                                                                                                                                                                                 | Pods are being started/updated                                  |
| AgentHealthy           | False            | AgentNotReady               | Fluent Bit agent DaemonSet is not ready                                                                                                                                                                                                ||
| AgentHealthy           | False            | AgentNotReady               | Pod is in pending state: 'with status message from the pod'                                                                                                                                                                             | Pod is in Pending state, the reason for this state is displayed |
| AgentHealthy           | False            | AgentNotReady               | Pod has failed: 'with status message from the pod'                                                                                                                                                                                     | Pod is in Failed state, the reason for this state is displayed  |
