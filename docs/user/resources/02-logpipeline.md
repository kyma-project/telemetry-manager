...
| **input.&#x200b;application.&#x200b;namespaces.&#x200b;exclude**  | \[\]string | Exclude specifies the list of Namespace names to exclude when collecting container logs. By default logs from all namespaces are getting collected except system namespaces. An exclude list cannot be specified together with an include list. |
| **input.&#x200b;application.&#x200b;namespaces.&#x200b;include**  | \[\]string | Include specifies the list of Namespace names to include when collecting container logs. By default logs from all namespaces are getting collected except system namespaces. An include list cannot be specified together with an exclude list. |
