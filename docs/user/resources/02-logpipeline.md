...
| AgentHealthy           | False            | AgentNotReady               | Pod is in pending state: 'with status message from the pod'                                                                                                                                                                             |
| AgentHealthy           | False            | AgentNotReady               | Pod has failed: 'with status message from the pod'                                                                                                                                                                                      |
