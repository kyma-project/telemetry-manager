...
In the following steps, you can see how to set up a typical LogPipeline. For an overview of all available attributes, see the [reference document](/docs/user/resources/02-logpipeline.md).
