...
| `prometheus.io/param_<name>: <value>`                            | `prometheus.io/param_format: prometheus` | none | Instruct Prometheus Receiver to pass <name>:<value> pairs as URL parameters when calling the metrics endpoint |
