...
By annotating the Service, all endpoints running behind the service will be resolved and scraped by the Metric agent using a direct connection to every Pod IP.
