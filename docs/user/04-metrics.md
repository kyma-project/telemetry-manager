...
The metric gateway maximum throughput is 34K metric data points/sec ~= 122.000.000 metric data points/hour. If more data must be ingested, it can be refused.
