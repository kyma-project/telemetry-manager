...
When you upgrade the Telemetry module to a version with VPA support, VPA activates for existing Telemetry pipelines. This triggers a one-time restart of Telemetry components as VPA applies its initial resource recommendations. During the initial adjustment period, you might observe Pod restarts as VPA learns your workload patterns. This is normal behavior.
