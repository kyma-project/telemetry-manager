...
> **NOTE:** The test results can vary up to 1000KByte/sec in the input, and up to 3000KByte/sec in the output processing rate with single pipeline tests. The Multi Pipeline test results can be lower than the single pipeline test results, as the test setup is shared between multiple pipelines and this may create pressure on the shared resources.
> 
## Self Monitor
