...
**Default Behavior:**
All Telemetry resources (annotation unset) use the `servicenameenrichment` processor (preserves existing behavior).
...
To adopt the new processor proactively, users can set the annotation manually.
