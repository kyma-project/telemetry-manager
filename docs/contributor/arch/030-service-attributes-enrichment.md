...
Currently, we use our custom `servicenameenrichment` processor for this enrichment. We should use the standard `k8sattributes` processor to eliminate our custom logic.
