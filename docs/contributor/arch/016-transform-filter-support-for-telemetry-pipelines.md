...
The converter functions support a broad variety of data types, including xlm, json, and string; not all of these functions are required for the current use cases, basic operation like string comparison, formatting and data type checks could be sufficient. 
