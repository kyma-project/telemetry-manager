...
| **telemetry_pipelines_log_pipeline_feature_usage** | Number of LogPipelines using specific features |
| **telemetry_pipelines_trace_pipeline_feature_usage** | Number of TracePipelines using specific features |
