...
func (in *EnrichmentSpec) DeepCopyInto(out *EnrichmentSpec) {
	*out = *in
	if in.ExtractPodLabels != nil {
		in, out := &in.ExtractPodLabels, &out.ExtractPodLabels
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogGatewaySpec) DeepCopyInto(out *LogGatewaySpec) {
	*out = *in
	in.Scaling.DeepCopyInto(&out.Scaling)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogGatewaySpec.
func (in *LogGatewaySpec) DeepCopy() *LogGatewaySpec {
	if in == nil {
		return nil
	}
	out := new(LogGatewaySpec)
	in.DeepCopyInto(out)
	return out
}
