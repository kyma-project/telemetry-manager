...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricInputSpec) DeepCopyInto(out *MetricInputSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricInputSpec.
func (in *MetricInputSpec) DeepCopy() *MetricInputSpec {
	if in == nil {
		return nil
	}
	out := new(MetricInputSpec)
	in.DeepCopyInto(out)
	return out
}
