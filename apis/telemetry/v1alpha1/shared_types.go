...
// +kubebuilder:validation:XValidation:rule="((has(self.value) && size(self.value) > 0) == true ? 1 : 0) + (has(self.valueFrom) == true ? 1 : 0) <= 1",message="Only one of 'value' or 'valueFrom' can be set"
