...
// +kubebuilder:object:root=true
// +kubebuilder:deprecatedversion:warning="telemetry.kyma-project.io/v1alpha1 TracePipeline is deprecated. Use telemetry.kyma-project.io/v1beta1 TracePipeline instead."
