...
// +kubebuilder:deprecatedversion:warning="The LogParser API is deprecated, use logging in JSON format instead and leverage the JSON parsing feature of the LogPipeline"
