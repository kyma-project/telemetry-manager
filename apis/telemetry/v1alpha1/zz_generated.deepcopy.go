...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricPipelineRuntimeInputResourceEnabled) DeepCopyInto(out *MetricPipelineRuntimeInputResourceEnabled) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricPipelineRuntimeInputResourceEnabled.
func (in *MetricPipelineRuntimeInputResourceEnabled) DeepCopy() *MetricPipelineRuntimeInputResourceEnabled {
	if in == nil {
		return nil
	}
	out := new(MetricPipelineRuntimeInputResourceEnabled)
	in.DeepCopyInto(out)
	return out
}
