...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogPipelineHTTPOutputTLS) DeepCopyInto(out *LogPipelineHTTPOutputTLS) {
	*out = *in
	if in.CA != nil {
		in, out := &in.CA, &out.CA
		*out = new(ValueType)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogPipelineHTTPOutputTLS.
func (in *LogPipelineHTTPOutputTLS) DeepCopy() *LogPipelineHTTPOutputTLS {
	if in == nil {
		return nil
	}
	out := new(LogPipelineHTTPOutputTLS)
	in.DeepCopyInto(out)
	return out
}
