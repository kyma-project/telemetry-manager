[![REUSE status](https://api.reuse.software/badge/github.com/kyma-project/directory-size-exporter)](https://api.reuse.software/info/github.com/kyma-project/directory-size-exporter)
