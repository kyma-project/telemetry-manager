...
const (
	otelImage              = "europe-docker.pkg.dev/kyma-project/prod/tpi/otel-collector:0.85.0-6130ed2c"
...
func main() {
	...
	flag.StringVar(&metricGatewayCPULimit, "metric-gateway-cpu-limit", "700m", "CPU limit for metrics OpenTelemetry Collector")
	flag.StringVar(&metricGatewayDynamicCPULimit, "metric-gateway-dynamic-cpu-limit", "500m", "Additional CPU limit for metrics OpenTelemetry Collector per MetricPipeline")
	flag.StringVar(&metricGatewayMemoryLimit, "metric-gateway-memory-limit", "500Mi", "Memory limit for metrics OpenTelemetry Collector")
	flag.StringVar(&metricGatewayDynamicMemoryLimit, "metric-gateway-dynamic-memory-limit", "1500Mi", "Additional memory limit for metrics OpenTelemetry Collector per MetricPipeline")
	flag.StringVar(&metricGatewayCPURequest, "metric-gateway-cpu-request", "100m", "CPU request for metrics OpenTelemetry Collector")
	flag.StringVar(&metricGatewayDynamicCPURequest, "metric-gateway-dynamic-cpu-request", "100m", "Additional CPU request for metrics OpenTelemetry Collector per MetricPipeline")
	flag.StringVar(&metricGatewayMemoryRequest, "metric-gateway-memory-request", "256Mi", "Memory request for metrics OpenTelemetry Collector")
