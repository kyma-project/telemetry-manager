...
func run() error {
	...
	flag.StringVar(&fluentBitExporterImage, "fluent-bit-exporter-image", constants.DefaultFluentBitExporterImage, "Image for exporting fluent bit filesystem usage")
	flag.StringVar(&fluentBitImage, "fluent-bit-image", constants.DefaultFluentBitImage, "Image for fluent-bit")
	flag.StringVar(&otelCollectorImage, "otel-collector-image", constants.DefaultOTelCollectorImage, "Image for OpenTelemetry Collector")
	flag.StringVar(&selfMonitorImage, "self-monitor-image", constants.DefaultSelfMonitorImage, "Image for self-monitor")
